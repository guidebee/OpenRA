...
namespace OpenRA.TemplateReader
{
	public class TemplateReader
	{
		...
		TemplateExportInfo ReadTemplateFromYaml(string yamlPath, ushort templateId, string tilesetName)
		{
			try
			{
		...
		TemplateExportInfo ReadTemplateFile(Stream stream, ushort templateId, string tilesetName)
		{
			try
			{
				// Debug file size
		...
		TemplateExportInfo CreateBasicTemplate(ushort templateId, string tilesetName)
		{
			var template = new TemplateExportInfo
			{
				Id = templateId,
		...
		static string GetTerrainTypeName(byte terrainType, string tilesetName)
		{
			// Return a terrain type name based on the tileset and terrain type index
			var tileset = tilesetName.ToUpperInvariant();
		...
		static string GetTilesetExtension(string tileset)
		{
